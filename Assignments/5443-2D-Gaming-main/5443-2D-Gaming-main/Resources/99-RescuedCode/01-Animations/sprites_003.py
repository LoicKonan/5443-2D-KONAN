...
Description:
    ...
    Use explosion class to perform multiple / different explosions.
"""
...
class Explosion(pygame.sprite.Sprite):
    def __init__(self, **kwargs):
        ...
        self.frame_rate = 80  # smaller = faster
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONUP:
                ...
                if pygame.time.get_ticks() % 2 == 0:
                    e = Explosion(
                        fx_sprites=config["sprite_sheets"]["explosion_01"]["path"],
                        loc=pygame.mouse.get_pos(),
                    )
                else:
                    e = Explosion(
                        fx_sprites=config["sprite_sheets"]["explosion_02"]["path"],
                        loc=pygame.mouse.get_pos(),
                    )
                all_sprites.add(e)
